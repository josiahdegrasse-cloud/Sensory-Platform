-- Keep CSV imports, generated surveys, and project identity connected.
-- The previous create_instrumental_import() body auto-created products/surveys,
-- but it predated projects.project_id propagation for newly imported batches.
